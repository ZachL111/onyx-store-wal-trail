"""Regression checks for the onyx-store-wal-trail casebook."""
...
from casebook.harness import assert_expected, onyx_store_wal_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_store_wal_trail_summary(), assert_expected())
